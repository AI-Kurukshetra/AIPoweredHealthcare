...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const channels = await unstable_cache(
      () => listChannels(supabase, orgId, pagination),
      ["api-communications", orgId, String(pagination.offset), String(pagination.limit)],
    ...
    return ok(channels, { headers: privateCacheHeaders() });
  } catch (error) {
